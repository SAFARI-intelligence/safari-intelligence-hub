...
function KshPrice({ kshAmount, usdAmount = null, size = "md" }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
      ...
      {usdAmount && (
        <span style={{ fontSize: s.sub, color: T.muted, marginTop: 1 }}>
          ≈ USD {usdAmount}
        </span>
      )}
    </div>
...
function MobileNav({ currentPage = "explore" }) {
    ...
    return (
      <>
        ...
        <div style={{
          ...
          background: "rgba(26,18,9,0.97)", backdropFilter: "blur(16px)",
  ...
  return (
    <nav style={{
      ...
      padding: "16px 40px", background: "rgba(26,18,9,0.95)", backdropFilter: "blur(12px)",
      borderBottom: `1px solid rgba(201,168,76,0.1)`, position: "sticky", top: 0, zIndex: 100,
    }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <span style={{ fontSize: 22 }}>🦁</span>
        <span style={{ color: T.gold, fontWeight: 900, fontSize: 20, letterSpacing: "0.08em" }}>SAFARI</span>
      </div>
      <div style={{ display: "flex", gap: 32 }}>
        {navItems.map(item => (
          <button key={item.id} style={{
            ...
            color: currentPage === item.id ? T.gold : T.muted,
            borderBottom: currentPage === item.id ? `2px solid ${T.gold}` : "2px solid transparent",
      ...
      <button style={{
        ...
        padding: "10px 22px", borderRadius: 6, fontWeight: 800, fontSize: 13,
    ...
    <div style={{
      ...
      <div style={{
        ...
        {lodge.availableRooms <= 3 && (
          <div style={{
            ...
            background: "rgba(139,26,26,0.9)", color: T.cream,
        ...
        <div style={{
          ...
          {lodge.tags.map(tag => (
            <span key={tag} style={{
              fontSize: 10, color: T.cream, background: "rgba(0,0,0,0.6)",
      ...
      <div style={{ padding: mobile ? "16px" : "20px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 }}>
          <div>
            <h3 style={{ fontSize: mobile ? 15 : 17, fontWeight: 800, color: T.cream, lineHeight: 1.2 }}>
              {lodge.name}
            </h3>
        ...
        <div style={{
          ...
          flexWrap: mobile ? "wrap" : "nowrap", gap: 12,
        }}>
          <div>
            <div style={{ fontSize: 10, color: T.muted, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 4 }}>
              Per night
            </div>
            <KshPrice kshAmount={lodge.pricePerNightKsh} usdAmount="~$218" size={mobile ? "md" : "lg"} />
          </div>
        ...
        <div style={{
          ...
          background: "rgba(45,90,39,0.1)", borderRadius: 6,
          display: "flex", alignItems: "center", gap: 8,
          border: `1px solid rgba(45,90,39,0.2)`,
        }}>
          <span style={{ fontSize: 14 }}>🌿</span>
          <span style={{ fontSize: 11, color: T.muted }}>
            <strong style={{ color: "#4CAF50" }}>KSh {lodge.conservationKsh.toLocaleString("en-KE")}</strong> of this booking funds local conservation
          </span>
        </div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 14 }}>🏆</span>
          <span style={{ fontSize: 11, color: T.muted }}>
            Earn <strong style={{ color: T.gold }}>{Math.round(totalKsh / 100).toLocaleString()} Simba Points</strong> on this booking
          </span>
        </div>
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative" }}>
        ...
        <h1 style={{
          fontSize: mobile ? 32 : 52, fontWeight: 900,
          color: T.cream, lineHeight: 1.1,
          fontFamily: "Georgia, 'Times New Roman', serif",
          marginBottom: 16,
        }}>
          Plan Your Kenya Safari<br />
          <span style={{ color: T.gold }}>in 2 Minutes</span>
        </h1>
        <p style={{
          fontSize: mobile ? 14 : 17, color: T.muted, lineHeight: 1.65,
          maxWidth: 480, margin: mobile ? "0 auto 28px" : "0 0 32px",
        }}>
        ...
        {/* CTA group */}
        <div style={{
          display: "flex", gap: 12, flexDirection: mobile ? "column" : "row",
          ...
          <button style={{
            ...
            border: `1px solid rgba(245,240,232,0.2)`, borderRadius: 8,
            padding: "16px 28px", fontWeight: 600, fontSize: 14,
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.black, color: T.cream }}>
      ...
      <div style={{
        ...
        background: "rgba(201,168,76,0.15)", border: `1px solid ${T.gold}`,
        borderRadius: 4, padding: "3px 8px", fontSize: 10, color: T.gold, fontWeight: 700,
      }}>
