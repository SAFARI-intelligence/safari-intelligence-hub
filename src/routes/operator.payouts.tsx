    ...
    >
      ...
      <div className="op-grid-payout-summary">
        <div className="op-card op-card-tight">
          ...
          <div className="op-kpi-value" style={{ marginTop: 6 }}>
            {formatKsh(totalPaid)}
          </div>
        </div>
        <div className="op-card op-card-tight">
        ...
        <div className="op-card op-card-tight">
          ...
          <div style={{ marginTop: 6, fontSize: 14, fontWeight: 500 }}>
            M-Pesa · {operator.mpesaMasked}
          </div>
          <span className="op-link" style={{ marginTop: 4, display: "inline-block" }}>
      ...
      <section className="op-card" style={{ overflowX: "auto" }}>
        <h2 className="op-h2" style={{ marginBottom: 10 }}>
          Payout schedule
        </h2>
      ...
      <section className="op-card">
        ...
        {open && (
          <div style={{ marginTop: 12, fontSize: 12, color: "var(--op-night)", lineHeight: 1.7 }}>
            <p>
              Gross booking value <strong>(KSh X)</strong> is what the guest pays at booking time.
            </p>
            <p>
              Safari platform commission <strong>(12%)</strong> is deducted:{" "}
              <code style={{ background: "#f5f1ea", padding: "1px 4px", borderRadius: 3 }}>
                Math.floor(X × 0.12)
              </code>{" "}
              — always rounded down in your favour.
            </p>
            <p>
              Net to operator: <strong>X − commission</strong>, paid out{" "}
              <strong>3 business days after guest check-out</strong> via your chosen payout method.
            </p>
            <p style={{ color: "var(--op-muted)" }}>
              Note: 0% commission applies until your first booking is completed — commission-only
              model. No platform charges if no bookings.
            </p>
          </div>
        )}
      </section>
