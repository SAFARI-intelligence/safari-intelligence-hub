  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const path: Array<[number, number]> = (
        (locsRes.data as Array<{ latitude: number; longitude: number }>) || []
      )
      ...
      <div className="mx-auto max-w-5xl space-y-10">
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 sm:p-10 text-white">
            ...
            <p className="font-display italic text-xl sm:text-2xl text-white/80 mt-3">
              {animal.title}
            </p>
          </div>
        </motion.section>
          ...
          <section>
            ...
            <div className="glass rounded-3xl p-4 mt-3">
              ...
              <p className="text-[10px] text-muted-foreground mt-2 flex items-center gap-1">
                <AlertTriangle className="h-3 w-3" /> Tracking points are delayed for animal safety.
                View the full live map at{" "}
                <Link to="/map" className="underline ml-1">
                  /map
                </Link>
                .
              </p>
        ...
        {animal.cultural_relevance && (
          <section
            ...
            style={{
              background:
                "linear-gradient(135deg, color-mix(in oklab, var(--cream) 80%, transparent), color-mix(in oklab, var(--gold) 15%, transparent))",
            }}
          >
